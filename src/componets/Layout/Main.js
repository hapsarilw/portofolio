    ...
    <MainStyles>
      <div id="main">
        <div id="sentences">
          ...
          <h3 className="text-xl text-grayish">
            Build your brand's recognation and got detailed insight on how your
        ...
        <div
          id="imageWorking"
        >
          <svg className="object-top" xmlns="http://www.w3.org/2000/svg" width="733" height="482">
            <defs>
